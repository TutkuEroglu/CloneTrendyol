...
export const themeLight = {
  ...
  colors: {
    ...
    iconColor: "#999",
    hiddenSpanColor: "#1b1b1b",
    hiddenSpanColorHover: "#9f9f9f",
    deliveryColor: "#DEFFED",
    truckIconColor: "#0BC15C",
    bttnColor: "#fff",
    hoverBackGround: "#099847",
    divBackGround: "#3ec461",
    freeDeliveryDiv: "#535353",
    spanColor: "#666",
    videoBackGround: "#ebf5ff",
    videoIcon: "#4A90E2",
    discountContectBg: "#FFF6EE",
    couponContectBg: "#FFF0F5",
    couponIcon: "#FF4988",
    checkboxColor: "#bfb",
    checkboxHover: "#B5B5B5",
    searchInput: "#fafafa",
    priceDiv: "#9c9c9c",
  },
  backgrounds: {
